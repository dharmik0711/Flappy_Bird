...
pipes_list = ['Images/Green_pipe.jpg', 'Images/Red_pipe.png']
pipe_surface = pygame.image.load(random.choice(pipes_list)).convert_alpha()
pipe_height = [150, 250, 350]

# Bird setup
bird_sur = pygame.image.load('Images/Bird.png').convert_alpha()
...
font = pygame.font.Font('Font/Evil_Empire.otf', 50)
